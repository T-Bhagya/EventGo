...
export const MOCK_EVENTS: EventItem[] = [
  ...
  {
    id: "evt-102",
    title: "Minimalist UI/UX & Design Systems Masterclass",
    ...
    location: "Design Studio 4, Innovation Building",
    isVirtual: true,
    price: "$15",
  ...
  {
    id: "evt-103",
    title: "Campus Acoustic Night & Live Art Showcase",
    organizer: "Student Arts Society",
    category: "Music",
    date: "Oct 10, 2026",
    time: "07:00 PM - 10:00 PM",
    location: "Central Courtyard Lawn",
    price: "Free",
    imageUrl: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=800&q=80",
    description:
      "An unforgettable evening featuring indie acoustic bands, live digital painting exhibitions, and artisan food trucks.",
    attendeesCount: 310,
    maxCapacity: 400,
    status: "upcoming",
    featured: false,
